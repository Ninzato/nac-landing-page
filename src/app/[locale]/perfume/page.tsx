...
export const metadata: Metadata = {
  ...
  description: 'Discover our exquisite collection of handcrafted perfumes. Signature fragrances, premium artisan scents, and luxury fragrance experiences from Nusantara Aroma Craft.',
  keywords: 'perfume, fragrance, artisan perfume, luxury scents, nusantara aroma craft, handcrafted perfume',
  openGraph: {
    title: 'Premium Perfume Collection | Nusantara Aroma Craft',
    description: 'Discover our exquisite collection of handcrafted perfumes. Signature fragrances, premium artisan scents, and luxury fragrance experiences.',
    images: [
      {
...
const PerfumeHome = () => {
  const structuredData = {
    ...
    description: 'Exquisite collection of handcrafted perfumes by Nusantara Aroma Craft',
    ...
    mainEntity: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          description: 'Handcrafted artisan perfumes with unique scent profiles',
